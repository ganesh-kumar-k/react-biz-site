         ...
         <div className="container">
             ...
             <div className="row about-container">
                 ...
                 <div className="col-lg-6 background order-lg-2 order-1 wow fadeInUp">
                     <img src={require("../img/about-img.svg")} className="img-fluid" alt=""/>
                 </div>
                 <div className="row about-extra">
                     <div className="col-lg-6 wow fadeInUp">
                         <img src={require("../img/about-extra-1.svg")} className="img-fluid" alt=""/>
                     </div>
                 ...
                 <div className="row about-extra">
                     <div className="col-lg-6 wow fadeInUp order-1 order-lg-2">
                         <img src={require("../img/about-extra-2.svg")} className="img-fluid" alt=""/>
                     </div>
